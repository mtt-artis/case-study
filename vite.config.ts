...
export default defineConfig({
  plugins: [
    ...
    UnoCSS({
      shortcuts: {
        btn: "text-white bg-indigo-500 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none disabled:bg-gray",
